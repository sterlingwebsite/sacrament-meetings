...
export default function NewMeetingPlaceholderPage() {
  return (
    <main className="max-w-2xl mx-auto py-12 px-4 text-center">
      <div className="p-8 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm space-y-4">
        <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center mx-auto text-xl">
          🛠️
        </div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 max-w-sm mx-auto">
          The forms, input validation rules, and mutation handlers required to insert new sacrament agendas into the database will be fully wired up next week.
        </p>
        <div className="pt-2">
          <Link
            href="/meetings"
